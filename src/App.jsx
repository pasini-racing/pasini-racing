    ...
    <div style={{minHeight:"100vh",background:"#0a0a0f",color:"#e8e8f0",fontFamily:"'Segoe UI',system-ui,sans-serif"}}>
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"20px 14px"}}>
        ...
        {view==="overview" && (function(){
          ...
          var CIRCUIT_SVGS = {
            "Estoril": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20 165 L240 165 C255 165 262 158 262 148 C262 138 255 132 240 132 L175 132 C165 132 158 126 155 118 L148 95 C145 87 138 82 128 82 L112 82 C102 82 96 75 96 66 L96 54 C96 44 102 38 112 38 L145 38 C155 38 162 32 165 23 M165 23 C168 14 178 8 190 10 C202 12 215 22 225 35 C235 48 238 62 232 75 C226 88 212 95 198 95 C185 95 175 88 170 78 C165 68 165 55 170 46 M20 165 C10 165 5 158 5 150 L5 142 C5 134 10 128 20 128 L35 128 C45 128 52 120 52 110 L52 80 C52 70 58 62 68 58 L80 54 C90 50 96 42 96 32 L96 20" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="115" y1="165" x2="115" y2="158" stroke="#ff4444" stroke-width="3"/><line x1="121" y1="165" x2="121" y2="158" stroke="white" stroke-width="3"/><text x="108" y="178" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Barcellona": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M25 155 L200 155 C215 155 222 148 222 138 L222 125 C222 115 215 108 205 108 L185 108 C175 108 168 100 168 90 L168 70 C168 55 178 42 195 38 L220 32 C235 28 245 18 242 8 M242 8 C240 2 232 -2 222 2 C212 6 205 15 205 25 L205 45 C205 58 195 68 182 68 L155 68 C142 68 132 58 132 45 L132 32 C132 20 122 12 110 12 L75 12 C58 12 45 22 40 35 L25 75 C18 90 18 108 25 122 L25 155Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="85" y1="155" x2="85" y2="148" stroke="#ff4444" stroke-width="3"/><line x1="91" y1="155" x2="91" y2="148" stroke="white" stroke-width="3"/><text x="78" y="170" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Jerez": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 155 L195 155 C210 155 218 148 218 136 C218 124 210 118 195 118 L170 118 C158 118 150 110 150 98 L150 75 C150 60 162 48 178 45 L205 40 C220 37 230 26 226 14 C222 4 210 -2 196 2 C182 6 174 18 176 32 L178 50 M30 155 C18 155 10 146 10 134 L10 118 C10 106 18 98 30 95 L50 90 C64 86 72 75 72 62 L72 45 C72 32 80 22 94 18 L115 14 C130 10 142 18 148 32 L150 50" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="90" y1="155" x2="90" y2="148" stroke="#ff4444" stroke-width="3"/><line x1="96" y1="155" x2="96" y2="148" stroke="white" stroke-width="3"/><text x="83" y="170" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Magny-Cours": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 50 L110 50 C122 50 128 58 128 68 L128 85 C128 97 138 105 150 105 L220 105 C235 105 242 115 238 128 L225 155 C218 168 205 175 190 172 L120 165 C105 162 95 152 95 138 L95 125 C95 112 85 105 72 108 L45 115 C30 118 20 108 22 94 L30 50Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="65" y1="50" x2="65" y2="42" stroke="#ff4444" stroke-width="3"/><line x1="71" y1="50" x2="71" y2="42" stroke="white" stroke-width="3"/><text x="58" y="38" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Valencia": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M30 160 L30 50 C30 32 44 18 62 18 L175 18 C193 18 207 32 207 50 L207 85 C207 100 195 112 180 112 L125 112 C110 112 98 124 98 139 L98 152 C98 165 88 175 75 175 C58 175 44 168 35 158 L30 160Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="62" y1="18" x2="68" y2="26" stroke="#ff4444" stroke-width="3"/><text x="42" y="14" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Aragon": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M25 155 L25 50 C25 32 38 18 56 18 L210 18 C228 18 242 30 244 48 L248 85 C250 102 238 115 221 118 L165 122 C150 124 140 135 140 150 L140 162 C140 175 130 182 118 180 C105 178 95 168 95 155 L95 138 C95 125 85 115 72 115 L48 115 C35 115 25 108 25 95 L25 155Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="75" y1="155" x2="75" y2="148" stroke="#ff4444" stroke-width="3"/><line x1="81" y1="155" x2="81" y2="148" stroke="white" stroke-width="3"/><text x="68" y="170" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
            "Misano": '<svg viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M25 158 L25 50 C25 32 38 18 56 18 L215 18 C233 18 246 30 246 48 L246 88 C246 105 233 118 216 118 L155 118 C140 118 128 130 128 145 L128 158 C128 172 118 180 105 178 C90 176 78 165 78 150 L78 135 C78 122 68 112 55 112 L45 112 C33 112 25 104 25 92 L25 158Z" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" fill="none"/><line x1="65" y1="158" x2="65" y2="150" stroke="#ff4444" stroke-width="3"/><line x1="71" y1="158" x2="71" y2="150" stroke="white" stroke-width="3"/><text x="58" y="173" fill="white" font-size="9" font-family="Arial" font-weight="bold">START</text></svg>',
          };
