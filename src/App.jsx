...
const PEOPLE = [
  {   id:"LUCA",   name:"Luca Tonolini",   firstName:"Luca",   lastName:"Tonolini",   role:"Capotecnico Borrelli - Pritelli",   email:"lucatonolini@gmail.com",   nationality:"italiana",   address:"CALCINATO",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA17277FH",   docExpiry:"16/04/2030",   tshirt:"L",   jacket:"M",   pants:"M",   username:"luca",   pin:"Luca124@",   isAdmin:true },
  {   id:"ILARIO",   name:"Ilario Pasini",   firstName:"Ilario",   lastName:"Pasini",   role:"Team Managre",   email:"ilario.pasini@icloud.com",   nationality:"italiana",   address:"OSPITALETTO",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA07343JB",   docExpiry:"21/06/2031",   tshirt:"XL",   jacket:"XL",   pants:"L",   username:"ilario",   pin:"Ilario124@",   canSeeCosts:true },
  {   id:"DAVIDE",   name:"Davide Migone",   firstName:"Davide",   lastName:"Migone",   role:"Elettronico Borrelli - Pritelli",   email:"migtheonly1@gmail.com",   nationality:"italiana",   address:"CREMA",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA77073JT",   docExpiry:"20/06/2032",   tshirt:"XL",   jacket:"XL",   pants:"L",   username:"davide",   pin:"Davide124@" },
  {   id:"MATTEO",   name:"Matteo Faggioli",   firstName:"Matteo",   lastName:"Faggioli",   role:"Meccanico Borrelli",   email:"matte7faggio@gmail.com",   nationality:"italiana",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA25467LL",   docExpiry:"01/02/2038",   tshirt:"M",   jacket:"M",   pants:"S",   username:"matteo",   pin:"Matteo124@" },
  {   id:"TOMMASO",   name:"Tommaso Faggioli",   firstName:"Tommaso",   lastName:"Faggioli",   role:"Meccanico Casadei",   email:"tommy7faggio@gmail.com",   nationality:"italiana",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA81528OO",   docExpiry:"01/02/2033",   tshirt:"M",   jacket:"M",   pants:"S",   username:"tommaso",   pin:"Tommaso124@" },
  {   id:"SAMULE",   name:"Samuele Donnini",   firstName:"Samuele",   lastName:"Donnini",   role:"Meccanico Pritelli",   email:"team@pasiniracingteam.it",   nationality:"italiana",   address:"FANO",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA33451YI",   docExpiry:"17/03/2035",   tshirt:"XL",   jacket:"L",   pants:"M",   username:"samuele",   pin:"Samuele124@" },
  {   id:"DANIELE",   name:"Daniele Tarquinio",   firstName:"Daniele",   lastName:"Tarquinio",   role:"Aiutante Michielon",   email:"danieletarquinio@outlook.it",   nationality:"italiana",   airport:"FCO",   docType:"carta d'identità",   docNum:"CA74097ET",   docExpiry:"11/08/2029",   tshirt:"L",   jacket:"L",   pants:"M",   username:"daniele",   pin:"Daniele124@" },
  {   id:"RICCARDO",   name:"Riccardo Bonometti",   firstName:"Riccardo",   lastName:"Bonometti",   role:"Aiutante Casadei",   email:"bonomettiriccardo805@gmail.com",   nationality:"italiana",   address:"OSPITALETTO",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA63188IA",   docExpiry:"11/02/2026",   tshirt:"L",   jacket:"L",   pants:"M",   username:"riccardo",   pin:"Riccardo124@" },
  {   id:"PEP",   name:"Josep Romeu Martinez",   firstName:"Josep",   lastName:"Romeu Martinez",   role:"Meccanico Michielon",   email:"josepromeu@hotmail.es",   nationality:"spagnola",   address:"BARCELLONA",   airport:"BCN",   docType:"carta d'identità",   docNum:"47794609B",   docExpiry:"31/07/2033",   tshirt:"L",   jacket:"L",   pants:"M",   username:"josep",   pin:"Josep124@" },
  {   id:"MAURI",   name:"Maurizio Chiari",   firstName:"Maurizio",   lastName:"Chiari",   role:"Autista",   email:"mauryc61@gmail.com",   nationality:"italiana",   address:"ROVATO",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA56344FS",   docExpiry:"28/02/2030",   tshirt:"L",   jacket:"L",   pants:"M",   username:"maurizio",   pin:"Maurizio124@" },
  {   id:"SANTIAGO",   name:"Santiago Frasca",   firstName:"Santiago",   lastName:"Frasca",   role:"Elettronico Casadei - Michielon",   email:"santiagofrasca.ms@gmail.com",   nationality:"italiana",   address:"ANCONA",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA40264VF",   docExpiry:"29/08/2034",   tshirt:"L",   jacket:"L",   pants:"M",   username:"santiago",   pin:"Santiago124@" },
  {   id:"GIACOMO",   name:"Giacomo Lavaroni",   firstName:"Giacomo",   lastName:"Lavaroni",   role:"Aiutante Borrelli - Pritelli",   email:"lavaronigiacomo@gmail.com",   nationality:"italiana",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA14751KU",   docExpiry:"13/12/2027",   tshirt:"XL",   jacket:"XL",   pants:"L",   username:"giacomo",   pin:"Giacomo124@" },
  {   id:"GUILLEM",   name:"Guillem Ordeig Serra",   firstName:"Guillem",   lastName:"Ordeig Serra",   role:"Capotecnico Casadei - Michielon",   email:"guillemordeig@gmail.com",   nationality:"spagnola",   address:"BARCELLONA",   airport:"BCN",   docType:"carta d'identità",   docNum:"47850206V",   docExpiry:"14/04/2027",   tshirt:"L",   jacket:"L",   pants:"M",   username:"guillem",   pin:"Guillem124@" },
  {   id:"BORRELLI",   name:"Cristian Borrelli",   firstName:"Cristian",   lastName:"Borrelli",   role:"Pilota Moto 4",   email:"cris.borre@yahoo.com",   nationality:"italiana",   airport:"BGY",   docType:"carta d'identità",   docNum:"CA50880LB",   docExpiry:"01/01/2028",   tshirt:"M",   jacket:"M",   pants:"M",   username:"cristian",   pin:"Cristian124@" },
  {   id:"PRITELLI",   name:"Lorenzo Pritelli",   firstName:"Lorenzo",   lastName:"Pritelli",   role:"Pilota Moto 4",   email:"lory.priti22@gmail.com",   nationality:"italiana",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA92009QF",   docExpiry:"22/08/2029",   tshirt:"M",   jacket:"M",   pants:"M",   username:"lorenzo",   pin:"Lorenzo124@" },
  {   id:"CASADEI",   name:"Leonardo Casadei",   firstName:"Leonardo",   lastName:"Casadei",   role:"Pilota Moto 4",   email:"leocasadei44@gmail.com",   nationality:"italiana",   airport:"BLQ",   docType:"carta d'identità",   docNum:"CA96979NM",   docExpiry:"01/11/2028",   tshirt:"M",   jacket:"M",   pants:"M",   username:"leonardo",   pin:"Leonardo124@" },
  {   id:"ERIK",   name:"Erik Michielon",   firstName:"Erik",   lastName:"Michielon",   role:"Pilota Moto3",   email:"erik.michielon10@gmail.com",   nationality:"italiana",   airport:"VCE",   docType:"carta d'identità",   docNum:"CA09858LQ",   docExpiry:"18/04/2027",   tshirt:"M",   jacket:"M",   pants:"M",   username:"erik",   pin:"Erik124@" },
  {   id:"SIMONE",   name:"Simone Corsini",   firstName:"Simone",   lastName:"Corsini",   role:"Sospensionista",   email:"simocorsa81@gmail.com",   nationality:"italiana",   airport:"PSA",   docType:"carta d'identità",   docNum:"CA73990DY",   docExpiry:"19/12/2029",   tshirt:"XXL",   jacket:"XXL",   pants:"XL",   username:"simone",   pin:"Simone124@" },
  {   id:"STEFANO",   name:"Stefano Ambrosi",   firstName:"Stefano",   lastName:"Ambrosi",   role:"Media",   nationality:"italiana",   airport:"BLQ",   docType:"carta d'identità",   docExpiry:"NaT",   username:"stefano",   pin:"Stefano124@" },
];
...
// EVENTS è mutabile: sincronizzato con Firestore (collezione "events") così l'admin
// può creare/eliminare eventi senza dover ricompilare l'app.
...
// ── BookingCard ───────────────────────────────────────────
function BookingCard({ b, compact, showPerson, onEdit, onDelete, isDuplicate }) {
  ...
  return (
    <div onClick={function(e){if(!e.target.closest("button")&&!e.target.closest("a")){if(typeof window.__showBookingDetail==="function") window.__showBookingDetail(b);}}}
      style={{background:tc.bg+"44",border:"1px solid "+(isDuplicate?"#ff4444":tc.accent+"33"),borderLeft:"3px solid "+(isDuplicate?"#ff4444":(flightPast?"#444":tc.accent)),borderRadius:8,padding:compact?"8px 12px":"12px 16px",marginBottom:8,display:"flex",flexWrap:"wrap",gap:8,alignItems:"center",position:"relative",opacity:flightPast?0.5:1,cursor:"pointer"}}>
      <span style={{fontSize:16}}>{tc.icon}{flightPast?" ✓":""}</span>
      {isDuplicate && <span style={{background:"#3a0a0a",color:"#ff6060",borderRadius:4,padding:"1px 7px",fontSize:10,fontWeight:800}}>⚠️ DOPPIONE</span>}
      ...
      {b.type === "hotel" && (
        <span style={{display:"contents"}}>
          {b.truck ? (
            <span style={{fontWeight:700,fontSize:12,color:"#ff9800"}}>🚛 Camion (nessuna prenotazione)</span>
          ) : (
            <span style={{display:"contents"}}>
              {b.address
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.8)",zIndex:2000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
      <div style={{background:"#12121f",borderRadius:14,padding:24,width:480,maxWidth:"100%",border:"1px solid #1e3a8a",maxHeight:"90vh",overflowY:"auto"}}>
        ...
        {booking.type==="hotel" && (
          <label style={{display:"flex",alignItems:"center",gap:8,background:form.truck?"#3d2a1a":"#0d0d1a",border:"1px solid "+(form.truck?"#ff9800":"#1e3a8a33"),borderRadius:8,padding:"10px 12px",marginBottom:14,cursor:"pointer"}}>
            <input type="checkbox" checked={!!form.truck} onChange={function(e){setForm(function(f){return Object.assign({},f,{truck:e.target.checked,hotel:e.target.checked?"Camion":f.hotel});});}} style={{width:16,height:16}}/>
            <span style={{fontSize:12,fontWeight:700,color:form.truck?"#ff9800":"#7090c0"}}>🚛 Dorme nel camion (nessuna prenotazione hotel)</span>
          </label>
        )}
        {booking.type==="auto" && (
          <label style={{display:"flex",alignItems:"center",gap:8,background:"#0d0d1a",border:"1px solid #1e3a8a33",borderRadius:8,padding:"10px 12px",marginBottom:14,cursor:"pointer"}}>
            <input type="checkbox" checked={form.roundTrip!==false} onChange={function(e){setForm(function(f){return Object.assign({},f,{roundTrip:e.target.checked});});}} style={{width:16,height:16}}/>
            <span style={{fontSize:12,fontWeight:700,color:"#4a9eff"}}>🔁 Andata e ritorno</span>
          </label>
        )}
          ...
          <div>
            ...
            {form.type==="hotel" && (
              <div>
                ...
                <label style={{display:"flex",alignItems:"center",gap:8,background:form.truck?"#3d2a1a":"#0d0d1a",border:"1px solid "+(form.truck?"#ff9800":"#1e3a8a33"),borderRadius:8,padding:"10px 12px",marginBottom:12,cursor:"pointer"}}>
                  <input type="checkbox" checked={!!form.truck} onChange={function(e){set("truck",e.target.checked);}} style={{width:16,height:16}}/>
                  <span style={{fontSize:12,fontWeight:700,color:form.truck?"#ff9800":"#7090c0"}}>🚛 Dorme nel camion (nessuna prenotazione hotel)</span>
                </label>
                {!form.truck && (
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
            ...
            {form.type==="auto" && (
              <div>
                <div style={{fontSize:13,fontWeight:800,color:"#4a9eff",marginBottom:12,paddingBottom:6,borderBottom:"1px solid #1e3a8a33"}}>🚗 Auto</div>
                <label style={{display:"flex",alignItems:"center",gap:8,background:"#0d0d1a",border:"1px solid #1e3a8a33",borderRadius:8,padding:"10px 12px",marginBottom:12,cursor:"pointer"}}>
                  <input type="checkbox" checked={!!form.roundTrip} onChange={function(e){set("roundTrip",e.target.checked);}} style={{width:16,height:16}}/>
                  <span style={{fontSize:12,fontWeight:700,color:"#4a9eff"}}>🔁 Andata e ritorno</span>
                </label>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
                ...
                <label style={{display:"flex",alignItems:"center",gap:8,background:form.alsoFlight?"#0d1a2a":"#0d0d1a",border:"1px solid "+(form.alsoFlight?"#4a9eff":"#1e3a8a33"),borderRadius:8,padding:"10px 12px",marginBottom:12,cursor:"pointer"}}>
                  <input type="checkbox" checked={!!form.alsoFlight} onChange={function(e){set("alsoFlight",e.target.checked);}} style={{width:16,height:16}}/>
                  <span style={{fontSize:12,fontWeight:700,color:form.alsoFlight?"#4a9eff":"#7090c0"}}>✈ Aggiungi anche il volo per questa persona</span>
                </label>
                {form.alsoFlight && (
                  <div style={{background:"#0d0d1a",borderRadius:8,padding:12,border:"1px solid #1e3a8a22",marginBottom:12}}>
                    <div style={{fontSize:11,fontWeight:800,color:"#4a9eff",marginBottom:10}}>✈ Dettagli Volo</div>
                    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                      ...
                      <div><label style={lbl}>Arrivo</label><input value={form.arr} onChange={function(e){set("arr",e.target.value);}} placeholder="es. BCN 13:35" style={inp}/></div>
                      <div><label style={lbl}>Bagaglio</label><input value={form.baggage} onChange={function(e){set("baggage",e.target.value);}} placeholder="es. 1 mano" style={inp}/></div>
                      <div><label style={lbl}>N° Prenotazione Volo</label><input value={form.flightBookingCode} onChange={function(e){set("flightBookingCode",e.target.value);}} placeholder="es. QUG2XP" style={inp}/></div>
                    </div>
                  </div>
                )}
              </div>
            )}
            {form.type==="parcheggio" && (
              <div>
...
// ── EventFormModal (crea nuovo evento, solo admin) ──────────
function EventFormModal({ onSave, onClose }) {
  var [form, setForm] = useState({label:"", dates:"", circuit:"", endDate:""});
  var canSave = form.label.trim().length>0;
  return (
    <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.9)",zIndex:2000,overflowY:"auto",padding:"20px 16px"}}>
      <div style={{maxWidth:440,margin:"0 auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:14}}>
          <div style={{fontSize:18,fontWeight:800,color:"#4caf50"}}>🏁 Nuovo Evento</div>
        ...
        <div style={{background:"#12121f",borderRadius:12,padding:18,border:"1px solid #4caf5033"}}>
          <label style={{fontSize:11,color:"#7090c0",display:"block",marginBottom:4}}>Nome evento *</label>
          <input value={form.label} onChange={function(e){setForm(Object.assign({},form,{label:e.target.value}));}} placeholder="Es. R8 Portimão"
            style={{width:"100%",padding:"9px 10px",background:"#0d0d1a",border:"1px solid #4caf5033",borderRadius:6,color:"#e8e8f0",fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:12}}/>
          <label style={{fontSize:11,color:"#7090c0",display:"block",marginBottom:4}}>Date (testo libero)</label>
          <input value={form.dates} onChange={function(e){setForm(Object.assign({},form,{dates:e.target.value}));}} placeholder="Es. 6-9 Nov"
            style={{width:"100%",padding:"9px 10px",background:"#0d0d1a",border:"1px solid #4caf5033",borderRadius:6,color:"#e8e8f0",fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:12}}/>
          <label style={{fontSize:11,color:"#7090c0",display:"block",marginBottom:4}}>Circuito</label>
          <input value={form.circuit} onChange={function(e){setForm(Object.assign({},form,{circuit:e.target.value}));}} placeholder="Es. Portimão"
            style={{width:"100%",padding:"9px 10px",background:"#0d0d1a",border:"1px solid #4caf5033",borderRadius:6,color:"#e8e8f0",fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:12}}/>
          <label style={{fontSize:11,color:"#7090c0",display:"block",marginBottom:4}}>Data di fine evento (opzionale — nasconde l'evento da "eventi passati" una volta trascorsa)</label>
          <input type="date" value={form.endDate} onChange={function(e){setForm(Object.assign({},form,{endDate:e.target.value}));}}
            style={{width:"100%",padding:"9px 10px",background:"#0d0d1a",border:"1px solid #4caf5033",borderRadius:6,color:"#e8e8f0",fontSize:13,outline:"none",boxSizing:"border-box",marginBottom:16}}/>
          <button onClick={function(){if(canSave) onSave(form);}} disabled={!canSave} style={{width:"100%",padding:12,background:canSave?"#14532d":"#0d0d1a",color:canSave?"#4caf50":"#555",border:"none",borderRadius:8,cursor:canSave?"pointer":"default",fontWeight:700,fontSize:14}}>✅ Crea evento</button>
        </div>
      </div>
    </div>
  );
    ...
    <div>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:18,flexWrap:"wrap",gap:10}}>
        ...
        <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
          ...
          <button onClick={function(){
              if (!window.confirm("Impostare la password di TUTTI i membri come Nome124@ (es. Luca124@)? Sovrascrive le password attuali.")) return;
              people.forEach(function(p){
                var fn = p.firstName || (p.name||"").trim().split(/\s+/)[0] || "";
                var ln = p.lastName || (p.name||"").trim().split(/\s+/).slice(1).join(" ");
                var merged = Object.assign({}, p, {firstName:fn, lastName:ln, pin:fn+"124@"});
                fbSet("people", p.id, merged);
                setPeople(function(prev){ return prev.map(function(x){ return x.id===p.id ? merged : x; }); });
              });
              showToast("Password aggiornate per "+people.length+" membri ✓");
            }} style={{background:"#0d1a2a",color:"#ff9800",border:"1px solid #ff980044",padding:"9px 14px",borderRadius:8,cursor:"pointer",fontWeight:700,fontSize:13}}>🔑 Password → Nome124@</button>
...
export default function App() {
  ...
  var [eventsVersion, setEventsVersion] = useState(0); // bump per forzare re-render dopo modifiche a EVENTS
  var [showEventForm, setShowEventForm] = useState(false);
  var [confirmDeleteEvent, setConfirmDeleteEvent] = useState(null);
  var [deletingEvent, setDeletingEvent] = useState(false);
  ...
  useEffect(function() {
    var unsub = db.collection("events").onSnapshot(function(snap) {
      if (snap.docs.length > 0) {
        EVENTS = snap.docs.map(function(d){ return Object.assign({id:d.id}, d.data()); });
      } else {
        var batch = db.batch();
        EVENTS_SEED.forEach(function(ev) {
          var ref = db.collection("events").doc(ev.id);
          batch.set(ref, {label:ev.label, dates:ev.dates, circuit:ev.circuit});
        });
        batch.commit().catch(function(e){console.error(e);});
        EVENTS = EVENTS_SEED.slice();
      }
      setEventsVersion(function(v){return v+1;});
    }, function(err){console.error(err);});
    return function(){unsub();};
  }, []);
  ...
  var duplicateBookingIds = useMemo(function(){
    ...
    Object.values(groups).forEach(function(arr){
      if (arr.length>1) arr.forEach(function(b){ if (b._id) ids.add(b._id); });
    });
    return ids;
  }, [bookings]);

  function createEvent(form) {
    var base = (form.label||"EVENTO").toUpperCase().normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^A-Z0-9]+/g,"_").replace(/^_+|_+$/g,"");
    var id = base || ("EVENTO_"+Date.now());
    var n = 1;
    while (EVENTS.some(function(e){return e.id===id;})) { n++; id = base+"_"+n; }
    var data = {label:form.label, dates:form.dates, circuit:form.circuit};
    if (form.endDate) data.endDate = form.endDate;
    db.collection("events").doc(id).set(data).then(function(){
      showToast("Evento \""+form.label+"\" creato ✓");
      setShowEventForm(false);
    }).catch(function(e){ showToast("Errore: "+e.message, "#ff4444"); });
  }
  ...
  async function deleteEventCascade(eventId) {
    ...
    try {
      ...
      var evBookings = bookings.filter(function(b){return b.event===eventId;});
      for (var i=0;i<evBookings.length;i++){ if (evBookings[i]._id) await fbDel("bookings", evBookings[i]._id); }
      setBookings(function(prev){return prev.filter(function(b){return b.event!==eventId;});});
      try { var docsSnap = await db.collection("eventDocs").where("event","==",eventId).get(); for (var j=0;j<docsSnap.docs.length;j++){ await docsSnap.docs[j].ref.delete(); } } catch(e){}
      try { var qrSnap = await db.collection("mealQR").where("event","==",eventId).get(); for (var k=0;k<qrSnap.docs.length;k++){ await qrSnap.docs[k].ref.delete(); } } catch(e){}
      try { var teamQrSnap = await db.collection("teamQR").where("event","==",eventId).get(); for (var t=0;t<teamQrSnap.docs.length;t++){ await teamQrSnap.docs[t].ref.delete(); } } catch(e){}
      try { var costsSnap = await db.collection("eventCosts").where("event","==",eventId).get(); for (var m=0;m<costsSnap.docs.length;m++){ await costsSnap.docs[m].ref.delete(); } } catch(e){}
      var noteKeys = Object.keys(eventNotes).filter(function(k){ return k.endsWith("_"+eventId); });
      for (var nn=0;nn<noteKeys.length;nn++){ await fbDel("notes", noteKeys[nn].replace(/[^a-zA-Z0-9_-]/g,"_")); }
      setEventNotes(function(prev){ var np=Object.assign({},prev); noteKeys.forEach(function(k){delete np[k];}); return np; });
      await fbDel("events", eventId);
      if (selEvent===eventId) { setSelEvent(null); }
      showToast("Evento \""+(ev?ev.label:eventId)+"\" ed elementi collegati eliminati ✓");
    } catch(e) {
      showToast("Errore durante l'eliminazione: "+e.message, "#ff4444");
    }
  ...
  var ACTIVE_EVENTS = EVENTS.filter(function(ev){
    ...
    var endDate = EVENT_END_DATES[ev.id] || (ev.endDate ? new Date(ev.endDate) : null);
    ...
    <div style={{minHeight:"100vh",background:"#0a0a0f",color:"#e8e8f0",fontFamily:"'Segoe UI',system-ui,sans-serif"}}>
      ...
      {hotelModal !== null && <HotelRoomAssigner
        ...
        onSave={function(bs){
          ...
          res.toAdd.forEach(function(b){ fbAdd("bookings",b).then(function(ref){ if(ref) setBookings(function(p){return p.concat([Object.assign({_id:ref.id},b)]);});}); });
          var msg = "Salvate "+res.toAdd.length+" prenotazioni hotel ✓";
          if (res.skipped.length) msg += " — "+res.skipped.length+" già presenti, saltate";
          showToast(msg);
        }}
      ...
      {addModal!==null && <AddBookingModal defaultEvent={addModal||undefined}
        onSave={function(bs){
          ...
          if (res.skipped.length) showToast(res.skipped.length===1 ? "1 prenotazione già presente, saltata" : res.skipped.length+" prenotazioni già presenti, saltate");
        }}
      ...
      {confirmDeleteEvent && (function(){
        var ev = EVENTS.find(function(e){return e.id===confirmDeleteEvent;});
        var n = bookings.filter(function(b){return b.event===confirmDeleteEvent;}).length;
        return (
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.85)",zIndex:4000,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}>
            <div style={{background:"#1a0a0a",borderRadius:14,padding:28,maxWidth:400,width:"100%",border:"2px solid #ff4444",textAlign:"center"}}>
              <div style={{fontSize:32,marginBottom:12}}>⚠️</div>
              <div style={{fontWeight:800,fontSize:16,marginBottom:8,color:"#ff6060"}}>Eliminare "{ev?ev.label:confirmDeleteEvent}"?</div>
              <div style={{fontSize:13,color:"#b0b0c0",marginBottom:20}}>
                Verranno eliminate definitivamente anche <b>{n}</b> prenotazion{n===1?"e":"i"} collegat{n===1?"a":"e"}, oltre a documenti, QR pasti, costi e note dell'evento. L'operazione non è reversibile.
              </div>
              <div style={{display:"flex",gap:10}}>
                <button onClick={function(){setConfirmDeleteEvent(null);}} disabled={deletingEvent} style={{flex:1,padding:11,background:"#0d0d1a",color:"#aaa",border:"1px solid #333",borderRadius:8,cursor:"pointer"}}>Annulla</button>
                <button onClick={function(){deleteEventCascade(confirmDeleteEvent);}} disabled={deletingEvent} style={{flex:1,padding:11,background:"#7f1d1d",color:"#ff6060",border:"none",borderRadius:8,cursor:deletingEvent?"default":"pointer",fontWeight:700,opacity:deletingEvent?0.6:1}}>{deletingEvent?"⏳ Elimino...":"🗑️ Elimina tutto"}</button>
              </div>
            </div>
          </div>
        );
      ...
      <div style={{maxWidth:1200,margin:"0 auto",padding:"20px 14px"}}>
          ...
          <div>
            ...
            {nextEv && currentUser && (
              <div style={{background:"#12121f",borderRadius:12,padding:16,marginBottom:16,border:"1px solid #4caf5033"}}>
                ...
                {/* 2. QR Pasti (unico per tutto il team) */}
                ...
                {(function(){
                  ...
                  return all.map(function(b,i){ return <BookingCard key={i} b={b} compact isDuplicate={b._id&&duplicateBookingIds.has(b._id)}/>; });
                })()}
              </div>
            )}
          ...
          return(
            <div>
              ...
              {visibleEvents.map(function(evId){
                ...
                return(
                  <div key={evId} style={{background:"#12121f",borderRadius:12,padding:18,marginBottom:14,border:"1px solid #ffffff11"}}>
                    ...
                    {evB.map(function(b,i){return <BookingCard key={i} b={b} isDuplicate={b._id&&duplicateBookingIds.has(b._id)} onEdit={isAdmin?handleEdit:null} onDelete={isAdmin?function(x){setConfirmDelete(x);}:null}/>;} )}
              ...
              <div style={{background:"#12121f",borderRadius:10,padding:14,marginBottom:14,border:"1px solid #4caf5022"}}>
                <div style={{fontSize:13,fontWeight:700,color:"#4caf50",marginBottom:10}}>🍽️ QR Code Pasti (squadra)</div>
                {events.map(function(evId){
                  var ev2 = EVENTS.find(function(e){return e.id===evId;});
                  return (
                    <div key={evId} style={{marginBottom:10}}>
                      <div style={{fontSize:11,fontWeight:700,color:"#7090c0",marginBottom:4}}>🏁 {ev2?ev2.label:evId}</div>
                      <TeamMealQR eventId={evId} isAdmin={false}/>
                    </div>
                  );
                })}
              </div>
        ...
        {view==="event" && !selEvent && (
          ...
          <div style={{display:"flex",justifyContent:"flex-end",marginBottom:12,gap:8}}>
            {isAdmin && <button onClick={function(){setShowEventForm(true);}} style={{fontSize:11,padding:"5px 12px",background:"#14532d",color:"#4caf50",border:"none",borderRadius:6,cursor:"pointer",fontWeight:700}}>➕ Nuovo evento</button>}
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(260px,1fr))",gap:14}}>
            {EVENTS.map(function(ev){
              ...
              return(
                <div key={ev.id} onClick={function(){setSelEvent(ev.id);}} style={{position:"relative",background:"#12121f",borderRadius:12,padding:18,border:"1px solid #1e3a8a33",cursor:"pointer"}}
                  onMouseEnter={function(e){e.currentTarget.style.border="1px solid #1e3a8a";e.currentTarget.style.transform="translateY(-2px)";}} onMouseLeave={function(e){e.currentTarget.style.border="1px solid #1e3a8a33";e.currentTarget.style.transform="translateY(0)";}}>
                  {isAdmin && <button onClick={function(e){e.stopPropagation();setConfirmDeleteEvent(ev.id);}} title="Elimina evento" style={{position:"absolute",top:10,right:10,background:"#3a0a0a",color:"#ff6060",border:"none",borderRadius:6,padding:"4px 7px",cursor:"pointer",fontSize:12}}>🗑️</button>}
                  <div style={{fontSize:18,fontWeight:800,marginBottom:4,paddingRight:isAdmin?24:0}}>{ev.label}</div>
            ...
            <div>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,flexWrap:"wrap",gap:8}}>
                ...
                <div style={{display:"flex",gap:8,alignItems:"center"}}>
                  ...
                  {isAdmin && <button onClick={function(){setConfirmDeleteEvent(selEvent);}} style={{background:"#3a0a0a",color:"#ff6060",border:"none",padding:"8px 14px",borderRadius:6,cursor:"pointer",fontSize:13,fontWeight:700}}>🗑️ Elimina evento</button>}
                </div>
              </div>
              ...
              {filterType==="all" ? people2.map(function(pid){
                ...
                return(
                  <div key={pid} style={{background:"#0d0d1a",borderRadius:10,padding:14,marginBottom:10,border:"1px solid #ffffff11"}}>
                    ...
                    {pBs.map(function(b,i){return <BookingCard key={i} b={b} compact={showingAll} isDuplicate={b._id&&duplicateBookingIds.has(b._id)} onEdit={isAdmin&&showingAll?handleEdit:null} onDelete={isAdmin&&showingAll?function(x){setConfirmDelete(x);}:null}/>;} )}
              ...
              }) : visibleBs.map(function(b,i){return <BookingCard key={i} b={b} showPerson={showingAll} isDuplicate={b._id&&duplicateBookingIds.has(b._id)} onEdit={isAdmin&&showingAll?handleEdit:null} onDelete={isAdmin&&showingAll?function(x){setConfirmDelete(x);}:null}/>;} )}
              {people2.length===0 && (
        ...
        {view==="add" && isAdmin && (
          <div>
            ...
            <div style={{maxWidth:560}}>
              <AddBookingForm onSave={function(bs){
                var res = dedupeBookings(bookings, bs);
                res.toAdd.forEach(function(b){fbAdd("bookings",b).then(function(ref){if(ref)setBookings(function(p){return p.concat([Object.assign({_id:ref.id},b)]);});}).catch(function(){setBookings(function(p){return p.concat([b]);});});});
                if (res.skipped.length) showToast(res.skipped.length===1 ? "1 prenotazione già presente, saltata" : res.skipped.length+" prenotazioni già presenti, saltate");
                setView("overview");
...
// ── CompletenessBadge ──────────────────────────────────────
// Small ✅/⚠️ indicator showing whether a person has volo+hotel, and whether the team QR pasti exists for this event.
function CompletenessBadge({ personId, eventId, bookings }) {
  var [hasTeamQR, setHasTeamQR] = useState(null); // null = loading
  useEffect(function(){
    var unsub = db.collection("teamQR").where("event","==",eventId).onSnapshot(function(snap){
      setHasTeamQR(snap.docs.length > 0);
    }, function(e){console.error(e); setHasTeamQR(false);});
    return function(){unsub();};
  },[eventId]);

  if (hasTeamQR === null) return null;
  ...
  if (!hasTeamQR) missing.push("QR Pasti team");
...
function ChecklistDashboard({ bookings, people, setView, setSelEvent, setViewAll }) {
  ...
  var [hasTeamQR, setHasTeamQR] = useState(false);

  useEffect(function(){
    if (!selEvent) { setHasTeamQR(false); return; }
    var unsub = db.collection("teamQR").where("event","==",selEvent).onSnapshot(function(snap){
      setHasTeamQR(snap.docs.length > 0);
    }, function(e){console.error(e);});
    return function(){unsub();};
  },[selEvent]);
  ...
  var CATEGORIES = [
    ...
    {key:"meal", label:"🍽️", full:"QR Pasti team"},
  ];
